...
La lettre 'd' montre que on l'objet 'repertoire' c'est une répertoire, le octet de permission "drwxr-x---" Les réticences dans le command supprime les information avec aucune pertinence pour cette exemple. 
