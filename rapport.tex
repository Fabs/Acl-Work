...
%What is posix% 
% Pendant le conception de la famille de "padron" POSIX 1003.1, le besoin de padroniser le domaine de sécurite  a été consideré dans les document 1003.1e (\emph{System Application Programming Interface}) and 1003.2c (\emph{Shell and Utilities}), "entretanto", la primiere approximation de ce sujet était trop "ambiciosa"
% 
...
%\begin{verbatim} 
% 	Si
% 		le ID d'utilisateur du process est le ID du proptieter, la entrée \textbf{owner} determines l'acess
% 	sinon
% 		le ID d'utilisateur du process es l'egal de le qualifier dans quelque entre de \textbf{utilisateur nome}, cette entrée determine l'acess
% 	else if
